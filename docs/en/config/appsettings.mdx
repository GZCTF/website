...
- **Uri:** Docker API Server Address
  ...
  - If you use external Docker, set `Uri` to the corresponding Docker API server. **External API authentication has not been implemented; this deployment method is not recommended.**
